...
<footer class="page-footer font-small mdb-color lighten-3 pt-4">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1">
        ...
        <ul class="list-unstyled">
          <li>
            <p>
              <i class="fas fa-home mr-3"></i> Hyderabad, lbnagar, 500060, TS</p>
          </li>
          <li>
            <p>
              <i class="fas fa-envelope mr-3"></i> infoEMS@gmail.com</p>
          </li>
          <li>
            <p>
              <i class="fas fa-phone mr-3"></i> +91 7032697496</p>
          </li>
          <li>
            <p>
  ...
  <div class="footer-copyright text-center py-3">© 2020 Copyright:
    <a href="https://git/kiranjubrewar/"> jubre kiran</a>
  </div>
  <!-- Copyright -->
